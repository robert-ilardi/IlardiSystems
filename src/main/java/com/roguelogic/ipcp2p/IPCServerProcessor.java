    ...
    switch (cmDatPair.getCommand()) {
      case CMD_RECEIVE_IPC_MESSAGE:
        try {
          ...
          System.err
              .println("An error occurred while attempting to deserialize IPC Message! See Stack Trace for more information. Disconnecting Client from IPC P2P Server! CmDatPair Dump: " + cmDatPair);
          e.printStackTrace();
