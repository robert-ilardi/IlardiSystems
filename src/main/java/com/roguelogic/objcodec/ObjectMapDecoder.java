...
public class ObjectMapDecoder {
  ...
  public void decode(HashMap source, Object target, String prefix, HashMap narrowUdoMap)
  ...
  public void decode(HashMap source, Object target, HashMap narrowUdoMap)
      throws IllegalArgumentException, InvocationTargetException, InstantiationException, IllegalAccessException, ClassNotFoundException {
    Set srcFields;
    Iterator iter;
  ...
  private void decode(Object target, ObjectTreeNode root, String parentName, HashMap narrowUdoMap)
      throws IllegalArgumentException, InvocationTargetException, InstantiationException, IllegalAccessException, ClassNotFoundException {
    ...
    for (int i = 0; i < primitiveNames.length; i++) {
      ...
      if (targetField != null) {
        ...
        if (setter != null) {
          ...
          // Invoke the Setter Method restoring the Object's State for the
          // primitiveNames[i] field
          if (objVal != null) {
