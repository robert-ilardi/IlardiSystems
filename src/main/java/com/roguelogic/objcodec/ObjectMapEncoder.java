...
public class ObjectMapEncoder {
  ...
  private String stringize(Object obj) {
    ...
    if (obj != null) {
      /*
       * if (obj instanceof Integer) { //Integer s = obj.toString(); } else if (obj
       * instanceof Character) { //Character s = obj.toString(); } else if (obj
       * instanceof Short) { //Short s = obj.toString(); } else if (obj instanceof
       * Long) { //Long s = obj.toString(); } else if (obj instanceof Float) { //Float
       * s = obj.toString(); } else if (obj instanceof Double) { //Double s =
       * obj.toString(); } else { s = obj.toString(); }
       */
