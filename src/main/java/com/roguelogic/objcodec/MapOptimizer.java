...
public class MapOptimizer implements Serializable {
  ...
  /*
   * public void addFieldOperation(String name, int operation) { FieldOperation fo
   * = new FieldOperation(); fo.setName(name); fo.setOperation(operation);
  ...
  /*
   * public void addGlobalOperations(String name, int operation) { FieldOperation
   * fo = new FieldOperation(); fo.setName(name); fo.setOperation(operation);
   * globalOperations.add(fo); }
   */
