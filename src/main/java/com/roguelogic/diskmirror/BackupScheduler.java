...
public class BackupScheduler implements Runnable {
  ...
  private void initTimeBasedScheduler() {
    ...
    dMirror.log("Scheduled Backup Execution Times: " + RLStringUtils.ArrayToDelimitedString(backupTimes, ", ", false));
  ...
  private void executeBackup() throws IOException, DiskMirrorException {
    ...
    dMirror.log(">>>> Total Backup Execution Time: " + RLStringUtils.CompactHumanReadableTime(totalTime));
  ...
  private void processRemoves() throws IOException {
    ...
    dMirror.log(">>>> Removal Processing Time: " + RLStringUtils.CompactHumanReadableTime(totalTime));
  }
  ...
  private void processCopies() throws IOException, DiskMirrorException {
    ...
    dMirror.log(">>>> Copied " + totalFilesCopied + (totalFiles == 1 ? " File" : " Files") + " in " + RLStringUtils.CompactHumanReadableTime(totalTime));
  }
