...
public class BackupScheduler implements Runnable {
  ...
  private void readProperties() {
    ...
    backupTimes = RLStringUtils.Trim(backupTimes);
  ...
  private void initTimeBasedScheduler() {
    ...
    publisher.log("Scheduled Backup Execution Times: " + RLStringUtils.ArrayToDelimitedString(backupTimes, ", ", false));
  ...
  private void executeBackup() throws RLNetException, OffSiteException, InterruptedException, IOException, IllegalBlockSizeException, BadPaddingException, InvalidKeySpecException,
    ...
    try {
      publisher.log("------------------------------------\n\nExecuting Scheduled Backup at: " + RLStringUtils.GetTimeStamp() + "\n");
      ...
      publisher.log(">>>> Total Backup Execution Time: " + RLStringUtils.CompactHumanReadableTime(totalTime));

      publisher.log("------------------------------------\n\nCompleted Scheduled Backup at: " + RLStringUtils.GetTimeStamp());
    } // End try block
    finally {
  ...
  private void processRemoves() throws RLNetException, OffSiteException, InterruptedException, IOException, IllegalBlockSizeException, BadPaddingException, InvalidKeySpecException,
    ...
    publisher.log(">>>> Removal Processing Time: " + RLStringUtils.CompactHumanReadableTime(totalTime));
  }
  ...
  private void processSends() throws RLNetException, OffSiteException, InterruptedException, IOException, IllegalBlockSizeException, BadPaddingException, InvalidKeySpecException,
    ...
    publisher.log(">>>> Sent " + totalFilesSent + (totalFiles == 1 ? " File" : " Files") + " in " + RLStringUtils.CompactHumanReadableTime(totalTime));
  }
