...
package com.roguelogic.sin.model;

public class SinStackServiceSignature extends BaseSinStackObjectModelObject {

  private String serviceName;
  private String serviceClassname;
  private String serviceInitOptions;

  public SinStackServiceSignature() {}
  ...
  public String getServiceInitOptions() {
    return serviceInitOptions;
  }

  public void setServiceInitOptions(String serviceInitOptions) {
    this.serviceInitOptions = serviceInitOptions;
  }

  @Override
  public String toString() {
    return "SinStackServiceSignature [serviceName=" + serviceName + ", serviceClassname=" + serviceClassname + ", serviceInitOptions=" + serviceInitOptions + "]";
  }
