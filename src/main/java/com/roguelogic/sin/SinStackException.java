...
public class SinStackException extends Exception {

  public SinStackException() {
    super();
  }
   ...
   * @param message
   */
  public SinStackException(String message) {
    super(message);
  }
   ...
   * @param cause
   */
  public SinStackException(Throwable cause) {
    super(cause);
  }
   ...
   * @param cause
   */
  public SinStackException(String message, Throwable cause) {
    super(message, cause);
  }
   ...
   */
  public SinStackException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
