...
import com.roguelogic.sin.SinStackService;
import com.roguelogic.sin.model.SinStackServiceSignature;

public abstract class BaseSinStackService implements SinStackService {

  protected Properties stackProps;

  protected SinStackServiceSignature serviceSignature;

  public BaseSinStackService() {}

  public void setStackProperties(Properties stackProps) {
    this.stackProps = stackProps;
  }

  public void setServiceSignature(SinStackServiceSignature serviceSignature) {
