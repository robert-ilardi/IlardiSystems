...
public class SimpleSSOController implements SSOController {
   ...
   * 
   * @see
   * com.roguelogic.roguenet.SSOController#initSSOCntrlr(java.util.Properties)
   */
   ...
   * (non-Javadoc)
   * 
   * @see com.roguelogic.roguenet.SSOController#establishSession(com.roguelogic.
   * entitlements.User)
   */
  public String establishSession(User user) throws RogueNetException {
    ...
    if (user != null) {
      sessionToken = RLStringUtils.GenerateTimeUniqueId();
   ...
   * 
   * @see
   * com.roguelogic.roguenet.SSOController#invalidateSession(java.lang.String)
   */
