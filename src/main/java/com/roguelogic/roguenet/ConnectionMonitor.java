...
public class ConnectionMonitor implements Runnable {
  ...
  public void start() throws InterruptedException {
    synchronized (monitorLock) {
      RNALogger.GetLogger().stdOutPrintln("Starting Connection Monitor (" + RLStringUtils.GetTimeStamp() + "):");
  ...
  public void stop() throws InterruptedException {
    synchronized (monitorLock) {
      RNALogger.GetLogger().stdOutPrintln("Stoping Connection Monitor (" + RLStringUtils.GetTimeStamp() + "):\n");
