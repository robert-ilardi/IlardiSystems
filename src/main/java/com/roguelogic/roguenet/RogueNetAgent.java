...
public class RogueNetAgent {
  ...
  private void loadPropertiesFiles() throws IOException {
    ...
    if (rnaPropFile != null) {
      ...
      rnaProps = RLSystemUtils.LoadPropertiesFile(rnaPropFile);
    }
    ...
    if (rnaProps != null) {
      try {
        ...
        if (!RLStringUtils.IsNVL(propFile)) {
    ...
    if (rnaProps != null) {
      try {
        ...
        if (!RLStringUtils.IsNVL(propFile)) {
          ...
          if (RLSystemUtils.FileExists(propFile)) {
    ...
    if (rnaProps != null) {
      try {
        ...
        if (!RLStringUtils.IsNVL(propFile)) {
          tmp = RLSystemUtils.GetHomeDirectory();
