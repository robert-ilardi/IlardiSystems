...
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_LOGIN;
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_LOGOUT;
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_PROP;
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_STATUS_PROP;
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_STATUS_SUCCESS;
import static com.roguelogic.roguenet.RNAConstants.SSO_MESSAGE_PROP;
import static com.roguelogic.roguenet.RNAConstants.SSO_PASSWORD_PROP;
import static com.roguelogic.roguenet.RNAConstants.SSO_RECEIVER_SUBJECT;
import static com.roguelogic.roguenet.RNAConstants.SSO_SESSION_TOKEN_PROP;
import static com.roguelogic.roguenet.RNAConstants.SSO_USERNAME_PROP;
...
public class FileRNAEntitlementsManager implements RNAEntitlementsManager, SynchronousTransactionRequestor {
   ...
   * 
   * @see
   * com.roguelogic.roguenet.RNAEntitlementsController#initEntitlementsManager(
   ...
   * 
   * @see
   * com.roguelogic.roguenet.RNAEntitlementsController#getEntitlementsController()
   */
  ...
  public String ssoLogin(String username, String password, String peer) throws RogueNetException {
    ...
    if (!RLStringUtils.IsNVL(username) && !RLStringUtils.IsNVL(password) && !RLStringUtils.IsNVL(peer) && plugInManager != null) {
  ...
  public boolean ssoLogout(String sessionToken, String peer) throws RogueNetException {
    ...
    if (!RLStringUtils.IsNVL(sessionToken) && !RLStringUtils.IsNVL(peer) && plugInManager != null && plugInManager.getNetAgent() != null) {
      mesg = new P2PHubMessage();
      mesg.setSubject(SSO_RECEIVER_SUBJECT);
      mesg.setRecipients(new String[] { peer });
