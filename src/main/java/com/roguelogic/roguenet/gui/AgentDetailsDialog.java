...
public class AgentDetailsDialog extends JFrame implements WindowListener {
  ...
  private void initComponents() {
     ...
     * GridBagConstraints.REMAINDER; gbc.weightx = 1.0; gbc.weighty = 1.0;
     * blankPanel = new JPanel(); blankPanel.setPreferredSize(new Dimension(1, 1));
     * gipGbl.setConstraints(blankPanel, gbc); genInfoPanel.add(blankPanel);
     */
        ...
        try {
          ...
          if (netExplorer != null) {
            ...
            if (plugInName != null && plugInName.trim().length() > 0) {
              ...
              JOptionPane.showMessageDialog(AgentDetailsDialog.this, "You MUST first select Plug-In from the list to view details!", Version.APP_TITLE, JOptionPane.INFORMATION_MESSAGE,
                  netExplorer.getRNATrayMenu().getIcon());
            }
          }
        }
        catch (Exception e) {
