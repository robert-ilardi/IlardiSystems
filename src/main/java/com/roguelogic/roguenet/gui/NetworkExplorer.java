...
import static com.roguelogic.roguenet.RNAConstants.NETWORK_EXPLORER_PLUG_IN_DETAILS_PROP_TABLE_TITLE;
import static com.roguelogic.roguenet.RNAConstants.NETWORK_EXPLORER_REPLY_SUBJECT;
import static com.roguelogic.roguenet.RNAConstants.PROP_NET_EXPLORER_LOCAL_LOOPING;
...
public class NetworkExplorer extends JFrame implements WindowListener {
  ...
  private String getRoundTripToken() {
    return RLStringUtils.GenerateTimeUniqueId();
  }
