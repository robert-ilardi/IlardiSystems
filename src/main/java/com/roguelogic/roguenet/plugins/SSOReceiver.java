...
import static com.roguelogic.roguenet.RNAConstants.SSO_ACTION_STATUS_FAILURE;
...
public class SSOReceiver implements RNAPlugIn {
   ...
   * 
   * @see
   * com.roguelogic.roguenet.RNAPlugIn#hook(com.roguelogic.roguenet.PlugInManager,
   * java.lang.String)
   */
   ...
   * 
   * @see
   * com.roguelogic.roguenet.RNAPlugIn#handle(com.roguelogic.p2phub.P2PHubMessage)
   */
