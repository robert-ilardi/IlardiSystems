...
public class RNAInfoDaemon implements RNAPlugIn {
  ...
  private String getUpTime() {
    return RLStringUtils.HumanReadableTime(upTime());
  }
  ...
  private String getJVMVersion() {
    ...
    sb.append(RLSystemUtils.GetJavaVersion());
    sb.append(" (");
    sb.append(RLSystemUtils.GetJavaVendor());
    sb.append(")");
  ...
  private String getOSName() {
    ...
    sb.append(RLSystemUtils.GetOperatingSystemName());
    sb.append(" (");
    sb.append(RLSystemUtils.GetOperatingSystemVersion());
    sb.append(")");
  ...
  private String getTotalHeap() {
    ...
    return nf.format(RLSystemUtils.GetTotalMemory());
  }
  ...
  private String getAvailableHeap() {
    ...
    return nf.format(RLSystemUtils.GetAvailableMemory());
  }
