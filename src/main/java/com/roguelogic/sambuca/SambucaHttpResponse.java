...
/**
 * This class represents a HTTP Response to be "sent" to the client. However it
 * is not a simple value-object, it is a hybrid object which has method to not
...
public class SambucaHttpResponse implements Serializable {
   ...
   * 
   * @param sockSession
   *          The RogueLogic Socket "connection" wrapper.
   */
   ...
   * 
   * @param contentType
   *          The content type string to be used as the Content-Type header.
   */
   ...
   * constants (most common ones/not a complete set) are available in this class.
   * See the constants: STATUS_CODE_*
   * 
   * @param statusCd
   *          The HTTP Status Code string such as "200 OK"
   */
  ...
  /**
   * This method can be used to add http headers to the response. Headers are not
   * written out to the socket until the first send(byte[]) method is invoked or
   * the sendHeaders() method is invoked.
   * 
   * @param header
   *          The name of the header to be added.
   * @param value
   *          The value of the header corresponding to the header name to be
   *          added.
   */
  ...
  /**
   * Sends the status code to the client. Will be invoked automatically by the
   * first invocation of sendHeaders.
   * 
  ...
  /**
   * Sends the header set to the client. If it is the first time this method is
   * invoked, the sendStatusCode() method is automatically called first.
   * 
   * @throws SambucaException
   */
  ...
  /**
   * This method can be called multiple times by the user. If it is the first
   * invocation of this method, then the sendHeaders() method will be called
   * automatically.
   * 
   * @param data
   * @throws SambucaException
