...
public class SimpleEchoWSFacade {
  ...
  public String multiEcho(String st, int i, float f, double d, char c, short s, long l, byte b, boolean bl, String[] sta, int[] ia, float[] fa, double[] da, char[] ca, short[] sa, long[] la,
    ...
    buf.append("Byte = ");
    buf.append(RLSystemUtils.GetAsciiFromByte(b));
    buf.append("\n");
    ...
    RLStringUtils.PrintArray(printer, "StringArray", sta);
    printer.close();
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "IntArray", ia);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "FloatArray", fa);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "DoubleArray", da);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "CharArray", ca);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "ShortArray", sa);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "LongArray", la);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "ByteArray", ba);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
    ...
    baos = new ByteArrayOutputStream();
    printer = new PrintStream(baos);
    RLStringUtils.PrintArray(printer, "BooleanArray", bla);
    printer.close();
    buf.append(new String(baos.toByteArray()));
    buf.append("\n");
