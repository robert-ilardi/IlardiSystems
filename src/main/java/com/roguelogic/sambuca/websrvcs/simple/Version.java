...
public class Version {
  ...
  public static final String SERVER_HEADER = new StringBuffer().append(APP_TITLE).append("/").append(VERSION).append(" (").append(RLSystemUtils.GetOperatingSystemName()).append(")").toString();
