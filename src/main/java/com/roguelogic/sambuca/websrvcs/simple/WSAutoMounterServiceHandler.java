...
public class WSAutoMounterServiceHandler implements ServiceHandler {
  ...
  private void sendForbidden(SambucaHttpRequest request, SambucaHttpResponse response) throws SambucaException {
    ...
    sb.append(SambucaHttpResponse.STATUS_CODE_FORBIDDEN);
    sb.append("</H1><PRE>");
    sb.append(RLStringUtils.SimpleHTMLTextEncoder(request.getUrl()));
    sb.append("</PRE>");
  ...
  private String getServerFooterHtml(SambucaHttpRequest request) {
    ...
    html.append(" (");
    html.append(RLSystemUtils.GetOperatingSystemName());
    html.append(") on port ");
  ...
  private void executeWsMethod(SambucaHttpRequest request, SambucaHttpResponse response)
      throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, SambucaException {
