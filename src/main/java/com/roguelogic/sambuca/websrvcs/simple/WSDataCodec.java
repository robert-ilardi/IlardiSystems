...
public class WSDataCodec {
  ...
  public static String EncodeByte(byte data) {
    return String.valueOf(RLSystemUtils.GetAsciiFromByte(data));
  }
  ...
  public static byte DecodeByte(String data) {
    return RLSystemUtils.GetByteFromAscii(Integer.parseInt(data.trim()));
  }
  ...
  public static String Encode(Object val) throws SambucaWebServiceException {
    ...
    if (val instanceof String[]) {
      ...
      throw new SambucaWebServiceException("Data Type '" + val.getClass().getName() + "' NOT support for Encoding!");
    }
