...
/**
 * An interface that represents a Sambuca based Logger. Users can implement this
...
public interface SambucaLogger {

  /**
   * Implementations of this interface MUST treat messages passed as the parameter
   * to this method as "Info" only. Non-Error Messages.
   * 
   * @param logMesg
  ...
  /**
   * Implementations of this interface MUST treat messages passed as the parameter
   * to this method as Error Messages which may or may not contain a throwable.
   * 
   * @param logMesg
   *          The LogMessage instance to be logged.
   */
