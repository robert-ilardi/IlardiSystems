...
public class EntitlementsManagementConsole extends JFrame implements WindowListener {
  ...
  private void paintUserGroupControlPanel() {
    ...
    // Last Row (User Groups Group List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
    ...
    // Last Row (User Groups User List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
    ...
    // Last Row (User Groups Group Users List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
  ...
  private void paintGroupItemControlPanel() {
    ...
    // Last Row (Group Items Group List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
    ...
    // Last Row (Item Groups Item List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
    ...
    // Last Row (Group Items Group Items List
    // Panel)------------------------------------------------------->
    gbc.gridwidth = GridBagConstraints.REMAINDER;
    gbc.gridheight = GridBagConstraints.REMAINDER;
    gbc.weightx = 1.0;
  ...
  private synchronized void ucpUpdateUser() {
    ...
    if (controller != null) {
      try {
        ...
        if (RLStringUtils.IsNVL(password)) {
  ...
  private synchronized void gcpUpdateGroup() {
    ...
    if (controller != null) {
      try {
        ...
        if (RLStringUtils.IsNVL(description)) {
