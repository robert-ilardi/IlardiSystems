...
public class SimpleFileEntitlementsController implements EntitlementsController {
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#userExists(com.roguelogic.
   * entitlements.User)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#createUser(com.roguelogic.
   * entitlements.User)
   */
  public synchronized void createUser(User user) throws EntitlementsException {
    ...
    if (user != null) {
      try {
        ...
        line = RLStringUtils.PrepareFixedLengthRecord(tokens, USERFILE_FIELD_PADDING, USERFILE_FIELD_PADDING_LEFT_DIRECTIONS, userFileFieldLens, true);
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#updateUser(com.roguelogic.
   * entitlements.User)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#deleteUser(com.roguelogic.
   * entitlements.User)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#preformUserDBMaintenance()
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#groupExists(com.roguelogic
   * .entitlements.Group)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#createGroup(com.roguelogic
   * .entitlements.Group)
   */
  public synchronized void createGroup(Group group) throws EntitlementsException {
    ...
    if (group != null) {
      try {
        ...
        line = RLStringUtils.PrepareFixedLengthRecord(tokens, GROUPFILE_FIELD_PADDING, GROUPFILE_FIELD_PADDING_LEFT_DIRECTIONS, groupFileFieldLens, true);
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#updateGroup(com.roguelogic
   * .entitlements.Group)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#deleteGroup(com.roguelogic
   * .entitlements.Group)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#preformGroupDBMaintenance(
   * )
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#itemExists(com.roguelogic.
   * entitlements.Item)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#createItem(com.roguelogic.
   * entitlements.Item)
   */
  public synchronized void createItem(Item item) throws EntitlementsException {
    ...
    if (item != null) {
      try {
        ...
        line = RLStringUtils.PrepareFixedLengthRecord(tokens, ITEMFILE_FIELD_PADDING, ITEMFILE_FIELD_PADDING_LEFT_DIRECTIONS, itemFileFieldLens, true);
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#updateItem(com.roguelogic.
   * entitlements.Item)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#deleteItem(com.roguelogic.
   * entitlements.Item)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#preformItemDBMaintenance()
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#linkUser(com.roguelogic.
   * entitlements.User, com.roguelogic.entitlements.Group)
   */
  public synchronized void linkUser(UserGroupLink link) throws EntitlementsException {
    ...
    if (link != null) {
      try {
        ...
        line = RLStringUtils.PrepareFixedLengthRecord(tokens, USERLINKFILE_FIELD_PADDING, USERLINKFILE_FIELD_PADDING_LEFT_DIRECTIONS, userLinkFileFieldLens, true);
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#unlinkUser(com.roguelogic.
   * entitlements.User, com.roguelogic.entitlements.Group)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#linkItem(com.roguelogic.
   * entitlements.Item, com.roguelogic.entitlements.Group)
   */
  public synchronized void linkItem(GroupItemLink link) throws EntitlementsException {
    ...
    if (link != null) {
      try {
        ...
        line = RLStringUtils.PrepareFixedLengthRecord(tokens, ITEMLINKFILE_FIELD_PADDING, ITEMLINKFILE_FIELD_PADDING_LEFT_DIRECTIONS, itemLinkFileFieldLens, true);
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#unlinkItem(com.roguelogic.
   * entitlements.Item, com.roguelogic.entitlements.Group)
   */
   ...
   * 
   * @see
   * com.roguelogic.entitlements.EntitlementsController#login(java.lang.String)
   */
  ...
  public synchronized User login(String username, String password) throws EntitlementsException {
    ...
    if (!RLStringUtils.IsNVL(username) && !RLStringUtils.IsNVL(password)) {
      try {
        f = new File(config.getUserFile());
        if (f.exists()) {
          raf = new RandomAccessFile(config.getUserFile(), "r");
  ...
  public synchronized void compactUserFile() throws IOException {
    ...
    if (srcFile.exists()) {
      File tmpFile = File.createTempFile(RLStringUtils.GenerateTimeUniqueId(), null);
      compactUserFile(tmpFile);
      RLSystemUtils.CopyFile(tmpFile.getAbsolutePath(), config.getUserFile());
      tmpFile.delete();
    }
  }
  ...
  public synchronized void compactUserFile(File destFile) throws IOException {
    ...
    if (srcFile.exists()) {
      try {
        ...
        while (line != null) {
          if (line.length() > 0) {
            tokens = RLStringUtils.FixedLengthSplit(line, userFileFieldLens);
  ...
  public synchronized void compactGroupFile() throws IOException {
    ...
    if (srcFile.exists()) {
      ...
      RLSystemUtils.CopyFile(tmpFile.getAbsolutePath(), config.getGroupFile());
      tmpFile.delete();
    }
  }
  ...
  public synchronized void compactGroupFile(File destFile) throws IOException {
    ...
    if (srcFile.exists()) {
      try {
        ...
        while (line != null) {
          if (line.length() > 0) {
            tokens = RLStringUtils.FixedLengthSplit(line, groupFileFieldLens);
  ...
  public synchronized void compactItemFile() throws IOException {
    ...
    if (srcFile.exists()) {
      ...
      RLSystemUtils.CopyFile(tmpFile.getAbsolutePath(), config.getItemFile());
      tmpFile.delete();
    }
  }
  ...
  public synchronized void compactItemFile(File destFile) throws IOException {
    ...
    if (srcFile.exists()) {
      try {
        ...
        while (line != null) {
          if (line.length() > 0) {
            tokens = RLStringUtils.FixedLengthSplit(line, itemFileFieldLens);
  ...
  public synchronized void compactUserGroupFile() throws IOException {
    ...
    if (srcFile.exists()) {
      ...
      RLSystemUtils.CopyFile(tmpFile.getAbsolutePath(), config.getUserGroupFile());
      tmpFile.delete();
    }
  }
  ...
  public synchronized void compactUserGroupFile(File destFile) throws IOException {
    ...
    if (srcFile.exists()) {
      try {
        ...
        while (line != null) {
          if (line.length() > 0) {
            tokens = RLStringUtils.FixedLengthSplit(line, userLinkFileFieldLens);
  ...
  public synchronized void compactGroupItemFile() throws IOException {
    ...
    if (srcFile.exists()) {
      ...
      RLSystemUtils.CopyFile(tmpFile.getAbsolutePath(), config.getGroupItemFile());
      tmpFile.delete();
    }
  }
  ...
  public synchronized void compactGroupItemFile(File destFile) throws IOException {
    ...
    if (srcFile.exists()) {
      try {
        ...
        while (line != null) {
          if (line.length() > 0) {
            tokens = RLStringUtils.FixedLengthSplit(line, itemLinkFileFieldLens);
  ...
  protected boolean userExists(RandomAccessFile raf, User user) throws IOException {
    ...
    if (raf != null && user != null && !RLStringUtils.IsNVL(user.getUsername())) {
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          ...
          if (tokens != null && tokens.length > 2 && tokens[USERFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && ENTRY_ACTIVE.equals(tokens[USERFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())) {
            ...
            if (!RLStringUtils.IsNVL(tokens[USERFILE_USERNAME_INDEX])) {
  ...
  protected void prepareUserFileFieldLens() {
    ...
    userFieldRecordLen = RLSystemUtils.Sum(userFileFieldLens);
  }
  ...
  protected String[] getUserRecord(RandomAccessFile raf, String username) throws IOException {
    ...
    if (raf != null && !RLStringUtils.IsNVL(username)) {
      raf.seek(0); // Start from the beginning of the file
      ...
      while (line != null) {
        if (line.length() > 0) {
          ...
          if (tokens != null && tokens[USERFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && tokens[USERFILE_USERNAME_INDEX] != null && ENTRY_ACTIVE.equals(tokens[USERFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())
            ...
            tokens = RLStringUtils.Trim(tokens);
            break;
          }
        } // End line length check
  ...
  protected HashMap<String, Group> loadGroupMap(String username) throws IOException {
    ...
    if (!RLStringUtils.IsNVL(username)) {
      try {
  ...
  protected String[] getGroupRecord(RandomAccessFile raf, String groupCode) throws IOException {
    ...
    if (raf != null && !RLStringUtils.IsNVL(groupCode)) {
      raf.seek(0); // Start from the beginning of the file
  ...
  protected HashMap<String, Item> loadItemMap(String groupCode) throws IOException {
    ...
    if (!RLStringUtils.IsNVL(groupCode)) {
      try {
  ...
  protected String[] getItemRecord(RandomAccessFile raf, String itemCode) throws IOException {
    ...
    if (raf != null && !RLStringUtils.IsNVL(itemCode)) {
      raf.seek(0); // Start from the beginning of the file
  ...
  protected boolean groupExists(RandomAccessFile raf, Group group) throws IOException {
    ...
    if (raf != null && group != null && !RLStringUtils.IsNVL(group.getCode())) {
      raf.seek(0); // Start from the beginning of the file
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          ...
          if (tokens != null && tokens.length > 2 && tokens[GROUPFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && ENTRY_ACTIVE.equals(tokens[GROUPFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())) {
            ...
            if (!RLStringUtils.IsNVL(tokens[GROUPFILE_CODE_INDEX])) {
              group.setCode(tokens[GROUPFILE_CODE_INDEX].trim());
            }

            if (!RLStringUtils.IsNVL(tokens[GROUPFILE_DESCRIPTION_INDEX])) {
  ...
  protected void prepareGroupFileFieldLens() {
    ...
    groupFieldRecordLen = RLSystemUtils.Sum(groupFileFieldLens);
  }
  ...
  protected boolean itemExists(RandomAccessFile raf, Item item) throws IOException {
    ...
    if (raf != null && item != null && !RLStringUtils.IsNVL(item.getCode())) {
      raf.seek(0); // Start from the beginning of the file
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          ...
          if (tokens != null && tokens.length > 2 && tokens[ITEMFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && ENTRY_ACTIVE.equals(tokens[ITEMFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())) {
            ...
            if (!RLStringUtils.IsNVL(tokens[ITEMFILE_CODE_INDEX])) {
              item.setCode(tokens[ITEMFILE_CODE_INDEX].trim());
            }

            if (!RLStringUtils.IsNVL(tokens[ITEMFILE_TYPE_INDEX])) {
              item.setType(tokens[ITEMFILE_TYPE_INDEX].trim());
            }

            if (!RLStringUtils.IsNVL(tokens[ITEMFILE_DESCRIPTION_INDEX])) {
  ...
  protected void prepareItemFileFieldLens() {
    ...
    itemFieldRecordLen = RLSystemUtils.Sum(itemFileFieldLens);
  }
  ...
  protected boolean userLinkExists(RandomAccessFile raf, UserGroupLink link) throws IOException {
    ...
    if (raf != null && link != null && !RLStringUtils.IsNVL(link.getUsername()) && !RLStringUtils.IsNVL(link.getGroupCode())) {
      raf.seek(0); // Start from the beginning of the file
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          tokens = RLStringUtils.FixedLengthSplit(line, userLinkFileFieldLens);
          if (tokens != null && tokens.length > 2 && tokens[USERLINKFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && tokens[USERLINKFILE_USERNAME_INDEX] != null && tokens[USERLINKFILE_GROUPCODE_INDEX] != null
              && ENTRY_ACTIVE.equals(tokens[USERLINKFILE_ENTRY_ACTIVE_FLAG_INDEX].trim()) && tokens[USERLINKFILE_USERNAME_INDEX].trim().equalsIgnoreCase(link.getUsername())
              && tokens[USERLINKFILE_GROUPCODE_INDEX].trim().equalsIgnoreCase(link.getGroupCode())) {
            exists = true;
            break;
          }
        }
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          ...
          if (tokens != null && tokens.length > 2 && tokens[USERLINKFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && ENTRY_ACTIVE.equals(tokens[USERLINKFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())) {
            ...
            if (!RLStringUtils.IsNVL(tokens[USERLINKFILE_USERNAME_INDEX])) {
              link.setUsername(tokens[USERLINKFILE_USERNAME_INDEX].trim());
            }

            if (!RLStringUtils.IsNVL(tokens[USERLINKFILE_GROUPCODE_INDEX])) {
  ...
  protected void prepareUserLinkFileFieldLens() {
    ...
    userLinkFieldRecordLen = RLSystemUtils.Sum(userLinkFileFieldLens);
  }
  ...
  protected boolean itemLinkExists(RandomAccessFile raf, GroupItemLink link) throws IOException {
    ...
    if (raf != null && link != null && !RLStringUtils.IsNVL(link.getItemCode()) && !RLStringUtils.IsNVL(link.getGroupCode())) {
      raf.seek(0); // Start from the beginning of the file
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          tokens = RLStringUtils.FixedLengthSplit(line, itemLinkFileFieldLens);
          if (tokens != null && tokens.length > 2 && tokens[ITEMLINKFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && tokens[ITEMLINKFILE_ITEMCODE_INDEX] != null && tokens[ITEMLINKFILE_GROUPCODE_INDEX] != null
              && ENTRY_ACTIVE.equals(tokens[ITEMLINKFILE_ENTRY_ACTIVE_FLAG_INDEX].trim()) && tokens[ITEMLINKFILE_ITEMCODE_INDEX].trim().equalsIgnoreCase(link.getItemCode())
              && tokens[ITEMLINKFILE_GROUPCODE_INDEX].trim().equalsIgnoreCase(link.getGroupCode())) {
            exists = true;
            break;
          }
        }
      ...
      while (line != null) {
        if (line.trim().length() > 0) {
          ...
          if (tokens != null && tokens.length > 2 && tokens[ITEMLINKFILE_ENTRY_ACTIVE_FLAG_INDEX] != null && ENTRY_ACTIVE.equals(tokens[ITEMLINKFILE_ENTRY_ACTIVE_FLAG_INDEX].trim())) {
            ...
            if (!RLStringUtils.IsNVL(tokens[ITEMLINKFILE_GROUPCODE_INDEX])) {
              link.setGroupCode(tokens[ITEMLINKFILE_GROUPCODE_INDEX].trim());
            }

            if (!RLStringUtils.IsNVL(tokens[ITEMLINKFILE_ITEMCODE_INDEX])) {
  ...
  protected void prepareItemLinkFileFieldLens() {
    ...
    itemLinkFieldRecordLen = RLSystemUtils.Sum(itemLinkFileFieldLens);
  }
