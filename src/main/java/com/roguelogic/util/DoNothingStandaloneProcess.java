...
public class DoNothingStandaloneProcess {
   ...
   * members have to debug not only the process but did the portion of the data
  ...
  private static boolean CheckCommandLineArguments(String[] args) {
    boolean ok = false;
    /*
     * This is configured to make sure we only have one parameter which is the app
     * properties. We could have made it more advanced and actually checked if the
     * file exists, but just checking is the parameter exists for demo purposes is
     * good enough.
     */
