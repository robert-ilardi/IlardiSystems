...
public class DesEncryptionHelper {
  ...
  public DesEncryptionHelper(String passPhrase, byte[] salt, int iterCnt)
      throws InvalidKeyException, InvalidAlgorithmParameterException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchPaddingException {
    // Create the key
