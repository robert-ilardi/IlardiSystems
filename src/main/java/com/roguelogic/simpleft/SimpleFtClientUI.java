...
public class SimpleFtClientUI {
  ...
  private void processUserInput(String userInput) {
    ...
    if (RLStringUtils.IsNVL(userInput)) {
      return;
    }

    try {
      userInput = userInput.trim();
      tokens = RLStringUtils.QuoteSplit(userInput.trim(), ' ');
      ...
      else if (!RLStringUtils.IsNVL(userInput)) {
  ...
  public void upload(String path, String remoteFileName, boolean syncWrite) throws SimpleFtException, RLNetException, InterruptedException, IOException {
    if (RLStringUtils.IsNVL(remoteFileName)) {
    ...
    String tmp = (new StringBuffer()).append("Starting ").append(syncWrite ? "Sync Upload" : "Upload").append(" at: ").append(RLStringUtils.GetTimeStamp()).toString();
    System.out.println(tmp);
    ...
    tmp = (new StringBuffer()).append("Finished Upload at: ").append(RLStringUtils.GetTimeStamp()).toString();
    System.out.println(tmp);

    tmp = (new StringBuffer()).append("Total Upload Time: ").append(RLStringUtils.CompactHumanReadableTime(totalTime)).append(" (").append(totalTime).append(" ms.)").toString();
    System.out.println(tmp);
  }
  ...
  public void download(String remoteFileName, String localPath, boolean syncRead) throws SimpleFtException, RLNetException, InterruptedException, IOException {
    if (RLStringUtils.IsNVL(localPath)) {
      localPath = remoteFileName;
    }

    String tmp = (new StringBuffer()).append("Starting ").append(syncRead ? "Sync Download" : "Download").append(" at: ").append(RLStringUtils.GetTimeStamp()).toString();
    System.out.println(tmp);
    ...
    tmp = (new StringBuffer()).append("Finished Download at: ").append(RLStringUtils.GetTimeStamp()).toString();
    System.out.println(tmp);

    tmp = (new StringBuffer()).append("Total Download Time: ").append(RLStringUtils.CompactHumanReadableTime(totalTime)).append(" (").append(totalTime).append(" ms.)").toString();
    System.out.println(tmp);
  }
