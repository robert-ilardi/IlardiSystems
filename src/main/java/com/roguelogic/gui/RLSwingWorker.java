...
public abstract class RLSwingWorker {
  ...
  public void startProgress() {
     ...
     * ProgressBarDialog((JFrame)window, title, text); } else if (window instanceof
     * JDialog) { bar = new ProgressBarDialog((JDialog)window, title, text);
     * isDisposed = false; } SwingUtilities.invokeLater(new Runnable() { public void
     * run() { // isDisposed = false; // if(bar != null && bar.is)
     * bar.setVisible(true);
     * 
     * } }); } }).start();
     */
